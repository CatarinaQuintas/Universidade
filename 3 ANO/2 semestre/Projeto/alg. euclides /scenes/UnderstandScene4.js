class UnderstandScene4 extends Phaser.Scene{
    constructor ()
    {
        super('UnderstandScene4');
    }
    preload() {
    ...
    create() 
    {
        ...
        this.backr.on('pointerdown', function () {
            game.scene.stop('UnderstandScene4');
            game.scene.start('UnderstandScene5');
        ...
        this.backl.on('pointerdown', function () {
            game.scene.stop('UnderstandScene4');
            game.scene.start('UnderstandScene3');
