class UnderstandScene3 extends Phaser.Scene{
    constructor ()
    {
        super('UnderstandScene3');
    }
    preload() {
    ...
    create() 
    {
        ...
        this.backr.on('pointerdown', function () {
            game.scene.stop('UnderstandScene3');
            game.scene.start('UnderstandScene4');
        ...
        this.backl.on('pointerdown', function () {
            game.scene.stop('UnderstandScene3');
            game.scene.start('UnderstandScene2');
