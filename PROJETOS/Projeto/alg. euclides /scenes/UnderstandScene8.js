class UnderstandScene8 extends Phaser.Scene{
    constructor ()
    {
        super('UnderstandScene8');
    }
    preload() {
    ...
    create() 
    {
        ...
        this.backl = this.add.sprite(1939,1093,'backl');
        ...
        this.backl.on('pointerdown', function () {
            game.scene.stop('UnderstandScene8');
            game.scene.start('UnderstandScene7');
